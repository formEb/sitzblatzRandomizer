...
function main() {   
    ...
    xobj.open('GET', "https://formeb.github.io/sitzplanRandomizer/students.json", true); // Replace 'my_data' with the path to your file
    xobj.onreadystatechange = function () {
      if (xobj.readyState == 4 && xobj.status == "200") {
        // Required use of an anonymous callback as .open will NOT return a value but simply returns undefined in asynchronous mode
        var yobj = new XMLHttpRequest();
            yobj.overrideMimeType("application/json");
            yobj.open('GET', "https://formeb.github.io/sitzplanRandomizer/assignment.json", true); // Replace 'my_data' with the path to your file
